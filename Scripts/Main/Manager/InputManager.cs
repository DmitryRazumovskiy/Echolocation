...
public class InputManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        actions.IncreaseLayer.performed     += context =>   actionController.ChangeObjectDistance( 1 );
        actions.DecreaseLayer.performed     += context =>   actionController.ChangeObjectDistance(-1 );
