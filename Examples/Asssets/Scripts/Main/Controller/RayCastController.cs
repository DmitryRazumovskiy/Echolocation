...
public class RayCastController : MonoBehaviour
{
    ...
    private void RayCasting()
    {
        ...
        if (Physics.Raycast(soundRay, out hit, soundRayLenght, layerMask))
        {
            ...
            {                
                ...
                if (objectHit.CompareTag("Audio Source Object"))
                {
                    ObjectAudioExperemental objectAudio = objectHit.GetComponent<ObjectAudioExperemental>();
    ...
    public AudioSource GetAudioSourceOfObject(Transform target)
    {
        ...
        if (target.CompareTag("Audio Source Object"))
        {
            ObjectAudioExperemental objectAudio = target.GetComponent<ObjectAudioExperemental>();
            return objectAudio.GetAudioSourceObject().GetComponent<AudioSource>();
        }
        else
        {
            AudioSource targetAduioSource = target.GetComponent<AudioSource>();
            return targetAduioSource;
        }
    }
